...
def main():
    ...
    lcd_test = st7565.lcd.LCD(adafruit=True)
    lcd_test.display_points_normal()
    screen_test = st7565.bitmap.Bitmap()
    time.sleep(3)
    screen_test.box(5, 5, 10, 10)
    lcd_test.write_buffer(screen_test)
